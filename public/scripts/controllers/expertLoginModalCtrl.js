connector.controller('ExpertLoginModalCtrl', ['$rootScope', '$scope', '$element', '$http', '$state', function($rootScope, $scope, $element, $http, $state) {
    ...
    $scope.forgotPassword = function () {
        $scope.cancel();
        $state.go('app.expertforgotpassword');
    };
    ...
    $scope.logIn = function () {
        ...
        $http.post('/experts/login', data).then(function(response){
